...
<div data-role="page" id="pageone">
  <div data-role="header">
	...
	<div data-role="navbar">
		...
		<li><a href="mypage.php" data-icon="heart" data-transition="flow"  class="ui-btn-active ui-state-persist">About</a></li>
...
<div data-role="panel" data-display="overlay" id="panel">
  ...
  <div data-role="main" class="ui-content">
  	<form data-ajax="false" action="mypage.php" method="post" name="myForm" id="myForm" onSubmit="return validate();" > 
    </br>
    <div data-role="controlgroup" data-type="horizontal">
    <input type="button" id="Add Staff" value=" + Add Staff" onClick="window.location.href='addstaff.html';"/>
    ...
    <?php
	$result = mysql_query("SELECT * FROM staffs ORDER BY email") or die("Error running MYSQL query");
	?>
	<tr>
	<td width="5%">#</td><td>Staff Name</td><td>Email</td><td>Address</td><td>Phone No</td>
	</tr>
	...
	{
		$del_id = $checkbox[$i];
		$sql = "DELETE FROM staffs WHERE email='$del_id'";
