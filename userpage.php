...
<div data-role="panel" data-display="overlay" id="panel">
  ...
  <div data-role="main" class="ui-content">
	...
	<tr>
	<td>Staff Name</td><td>Email</td><td>Project ID</td><td>Project Name</td><td>Date</td>
	</tr>
	...
	<tr>
    <td align= 'center'><?php echo "<a href='print.php?pro_name=".$row['pro_name']."&pro_id=".$row['pro_id']."'>".$row['name']."</a>";?></td>
